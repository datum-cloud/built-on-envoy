...
// Package main is the entry point for the standalone version of the openapi-validator extension.
package main

import (
	shared "github.com/envoyproxy/envoy/source/extensions/dynamic_modules/sdk/go/shared"

	impl "github.com/tetratelabs/built-on-envoy/extensions/go-bundle/openapi-validator"
)

// WellKnownHttpFilterConfigFactories is the plugin entry point when running it as an
// independently loaded gobundle plugin.
